...
import { gender2zh, type2zh } from '@/stores/manager'
...
import { backgroundColor, getElementColor, parseRaces } from '@/components/worldflipper/worldflipperGlobal.ts'
    ...
    <template v-if='obj'>
      ...
      >
        ...
        '
          ...
          135deg,
          ${color} 130px,
          ${backgroundColor} 130px,
          ${backgroundColor} calc(100% - 32px),
