              ...
              <div style="display: flex; flex-direction: column">
                ...
                <div class="span-ability" style="padding-bottom: 4px">
                  ...
                  <ContentCover>
                    ...
                    <template v-slot:cover>
                      <div v-if="obj.skill.description" style="margin: 0 8px" v-html="format_content(obj.skill.description || '')" />
              ...
              <div style="display: flex; flex-direction: column">
                ...
                <div class="span-ability">
                  ...
                  <ContentCover>
                    ...
                    <template v-slot:cover>
                      <div v-if="obj.abilities[2]" style="margin: 0 8px" v-html="format_content(obj.abilities[2] || '')" />
                      <div v-else style="margin: 0 8px">--</div>
                    </template>
                  </ContentCover>
                </div>
                <div class="span-ability">
                  ...
                  <ContentCover>
                    ...
                    <template v-slot:cover>
                      <div v-if="obj.abilities[3]" style="margin: 0 8px; opacity: 0.55" v-html="format_content(obj.abilities[3] || '')" />
                ...
                <div class="span-ability">
                  ...
                  <ContentCover>
                    ...
                    <template v-slot:cover>
                      <div v-if="obj.abilities[4]" style="margin: 0 8px; opacity: 0.55" v-html="format_content(obj.abilities[4] || '')" />
                      <div v-else style="margin: 0 8px; opacity: 0.55">--</div>
                    </template>
                  </ContentCover>
                </div>
                <div class="span-ability">
                  ...
                  <ContentCover>
                    ...
                    <template v-slot:cover>
                      <div v-if="obj.abilities[5]" style="margin: 0 8px; opacity: 0.55" v-html="format_content(obj.abilities[5] || '')" />
                      <div v-else style="margin: 0 8px; opacity: 0.55">--</div>
                    </template>
                  </ContentCover>
                </div>
