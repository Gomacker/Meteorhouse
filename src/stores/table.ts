...
export function format_content(content: string, icon_size: number=24): string {
    ...
    s += '</p>'
    s = s.replaceAll('火属性', '<img style="width: ' + icon_size + 'px; vertical-align: text-bottom; margin: 0 2px;" src="/static/worldflipper/icon/desc_fire.png" alt=""/>')
    s = s.replaceAll('水属性', '<img style="width: ' + icon_size + 'px; vertical-align: text-bottom; margin: 0 2px;" src="/static/worldflipper/icon/desc_water.png" alt=""/>')
    s = s.replaceAll('雷属性', '<img style="width: ' + icon_size + 'px; vertical-align: text-bottom; margin: 0 2px;" src="/static/worldflipper/icon/desc_thunder.png" alt=""/>')
    s = s.replaceAll('风属性', '<img style="width: ' + icon_size + 'px; vertical-align: text-bottom; margin: 0 2px;" src="/static/worldflipper/icon/desc_wind.png" alt=""/>')
    s = s.replaceAll('風属性', '<img style="width: ' + icon_size + 'px; vertical-align: text-bottom; margin: 0 2px;" src="/static/worldflipper/icon/desc_wind.png" alt=""/>')
    s = s.replaceAll('光属性', '<img style="width: ' + icon_size + 'px; vertical-align: text-bottom; margin: 0 2px;" src="/static/worldflipper/icon/desc_light.png" alt=""/>')
    s = s.replaceAll('暗属性', '<img style="width: ' + icon_size + 'px; vertical-align: text-bottom; margin: 0 2px;" src="/static/worldflipper/icon/desc_dark.png" alt=""/>')
    s = s.replaceAll('闇属性', '<img style="width: ' + icon_size + 'px; vertical-align: text-bottom; margin: 0 2px;" src="/static/worldflipper/icon/desc_dark.png" alt=""/>')
    s = s.replaceAll('作为主要角色编成：', '<img style="width: ' + icon_size + 'px; vertical-align: text-bottom; margin: 0 2px;" src="/static/worldflipper/icon/desc_main.png" alt=""/>')
